...
segments = time_tagger._generate_segments("\"" + __root + "file\\crawler\\av30199696\\1_52660766\\52660766-part0.flv\"")
...
segments_graded = time_tagger._grade_segments(segments,real_time_comments)
